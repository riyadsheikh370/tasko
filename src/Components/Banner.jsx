                ...
                <Container>
                    <div className="flex w-[100%] justify-between">
                        ...
                        <div className="w-[50%] pt-[40]">
                            <h4 className='leading-[81.98px] mt-[200px] font-jsans text-[white] text-[53px] font-bold'>Arcabit Internet Security</h4>
                            ...
                            <div className="group inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#8B0000] to-[#e21111] text-white font-medium transition-all duration-300 hover:from-[#a80000] hover:to-[#cc1010]">
                                ...
                                <span className="p-[4px] bg-[#b2b2b2] rounded-[15px] ml-[10px]">
                                    <HiArrowSmRight />
                                </span>
                            </div>
